  ...
  function chk(){
    ...
    <body>
        <div class=all>
            ...
            <div class="form">
                <h1>修改密碼</h1>
                <form action="changeps.php" method="post" name="send" onsubmit="return chk();">
                <input name="pw" id="password" type="password" placeholder="請輸入舊密碼" class="textbox" onkeyup="this.value=this.value.replace(/[\W]/g,'') "
    onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"/>
                <input name="pw1" id="password1" type="password" placeholder="請輸入新密碼" class="textbox" onkeyup="this.value=this.value.replace(/[\W]/g,'') "
    onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"/>
                <input name="pw2" id="password2" type="password" placeholder="再次確認密碼" class="textbox" onkeyup="this.value=this.value.replace(/[\W]/g,'') "
    onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"/>
